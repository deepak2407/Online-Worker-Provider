...
<div id="content_ext">
    <center>
        <div style="margin-top: 100px;font-size:1.3em;font-family: candara;background:#607B8B;color:white;">Admin Profile page</div>
        <div style="border-radius: 5px;background-color:#607B8B;padding-top:10px;padding-bottom: 10px;width:60%;margin-top: 100px;">
            <form action="adminprofile1.php">
        ...
        //           {
                    ...
                    $result = mysqli_query($con, "select * from admin where mail='$mail'");
